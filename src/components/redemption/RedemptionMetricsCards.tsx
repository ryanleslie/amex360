...
export function RedemptionMetricsCards({ 
  ...
  const cardData = [
    ...
    },
    {
      ...
      icon: Plane,
      footer: `${stats.airfareRedemptions} redemptions ${getTimeRangeDescription(filters.selectedTimeRange)}`,
    ...
    },
    {
      ...
      icon: MapPin,
      footer: `${stats.accommodationRedemptions} redemptions ${getTimeRangeDescription(filters.selectedTimeRange)}`,
      description: `Total redemptions ${getTimeRangeDescription(filters.selectedTimeRange)}`,
      clickable: true,
